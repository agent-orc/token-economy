...
public sealed class RoutingEvidenceAggregator
{
    ...
    private static string? TaskClass(string? value) => value?.Trim().ToLowerInvariant() switch
    {
        ...
        "decision" or "decision-making" => "decision-making",
        "html-ui" or "html-ui-implementation" or "frontend" => "html-ui-implementation",
        "source-code-review" or "code-review" => "source-code-review",
        "security-assessment" or "security-review" => "security-assessment",
        "redundancy-detection" => "redundancy-detection",
        "graphical-quality-judgment" => "graphical-quality-judgment",
